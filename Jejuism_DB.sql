...
SELECT * FROM VISIT_JEJU WHERE TITLE LIKE '%박물관%';
-- SELECT * FROM VISIT_JEJU WHERE (ALLTAG LIKE '%힐링%' OR TITLE LIKE '%힐링%' OR TAG LIKE '%힐링%') AND CODE LIKE '관광지';
-- SELECT * FROM VISIT_JEJU WHERE CODE LIKE '관광지' AND TITLE LIKE '%힐링%';
/*
SELECT  
...
/*
INSERT INTO REVIEW VALUES(0, 1, 1, 4.5, '이번에 다녀왔는데 진짜 예뻐요', DEFAULT, DEFAULT);
INSERT INTO REVIEW VALUES(0, 1, 1, 4, '이번에 다녀왔는데 진짜 예뻐요1111', DEFAULT, DEFAULT);
INSERT INTO REVIEW VALUES(0, 1, 1, 3.5, '이번에 다녀왔는데 진짜 예뻐요2222', DEFAULT, DEFAULT);
INSERT INTO REVIEW VALUES(0, 1, 1, 5, '이번에 다녀왔는데 진짜 예뻐요3333', DEFAULT, DEFAULT);
INSERT INTO REVIEW VALUES(0, 1, 1, 4.5, '이번에 다녀왔는데 진짜 예뻐요4444', DEFAULT, DEFAULT);
*/
...
COMMIT;
SELECT * FROM TEMP;
ALTER TABLE TEMP MODIFY REGID MEDIUMTEXT;
