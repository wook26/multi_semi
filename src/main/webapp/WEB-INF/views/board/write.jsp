...
<section class="pt-7 pb-7 d-flex align-items-end dark-overlay bg-cover"
  ...
  <div class="container py-2">
    ...
    <a class="text-custom-gray400" href="category-comunity.html">커뮤니티 </a>
    <p class="d-inline-block text-custom-gray400"><i class="fa-solid fa-chevron-right"></i></p>
    <p class="d-inline-block text-custom-gray400"> 글 쓰기</p>
  </div>
        ...
        <form action="${path}/board/write"  method="post" enctype="multipart/form-data">
          <table class="table" id="tbl-board">
            <tr>
              ...
              <th>
                <select class="form-select" name="type" aria-label="Default select example">
                  <option value="type1" selected>여행 일정/후기</option>
                  <option value="type2">여행 동행 모집</option>
                </select>
              </th>
            </tr>
            <tr>
              ...
              <td>
                <input class="w-100 write-form" type="text" name="title">
              </td>
            ...
            <tr>
              ...
              <td>
                <input class="w-100 write-form" type="text" name="writerId" value="${loginMember.id}" readonly>
              </td>
            </tr>
            <tr>
              <th class="align-middle text-center">첨부파일</th>
              <th><input class="w-25" type="file" name="upfile"></th>
            </tr>
            <tr>
              <th class="align-middle text-center">글 내용</th>
              <td><textarea class="w-100 write-form" name="content" cols="50" rows="15"></textarea></td>
            </tr>
          </table>
          <div class="text-center pb-5">
            <input type="submit" class="btn btn-primary" value="등록">
            <input type="reset" class="btn btn-primary ms-3">
          </div>
        </form>
      </div><!--폼 둘러싸는 용도-->
