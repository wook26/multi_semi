...
<section id="content">
	...
	<h3>회원가입</h3>
	<a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=b8ade2206b088dfc71ea53cea331733f&redirect_uri=http://localhost/mvc/member/enroll/kakao">
		<img src="${path}/resources/images/kakao_login_medium_narrow.png" >
	</a>
	<br>
	
	<h3>로그인</h3>
	<a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=b8ade2206b088dfc71ea53cea331733f&redirect_uri=http://localhost/mvc/kakaoLogin">
