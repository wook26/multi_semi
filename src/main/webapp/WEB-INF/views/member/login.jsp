            ...
            <div class="mb-5"><img class="img-fluid mb-3" src="${path}/resources/image/logo_notxt.svg" alt="..." style="max-width: 4rem;">
             ...
             <form class="form-validate" action="${path}/user/login" method="post">
              <div class="mb-4">
                ...
                <input class="form-control" name="id"  type="text" placeholder="아이디" autocomplete="off" required data-msg="아이디를 입력해주세요.">
              </div>
              <div class="mb-4">
                <div class="row">
                  <div class="col">
                ...
                <input class="form-control" name="password"  placeholder="비밀번호" type="password" required data-msg="비밀번호를 입력해주세요.">
              </div>
              <div class="mb-4">
              ...
              <div class="d-grid gap-2">
                ...
                <button class="btn btn-social kakao"><img class="btn-social-icon" src="${path}/resources/image/kakao.svg">카카오 아이디로 <span class="d-none d-sm-inline">로그인</span></button>
              ...
              <hr class="my-4">
              <p class="text-center"><small class="text-muted text-center">아직 회원이 아니신가요? <a class="text-primary" href="${path}/user/enroll">회원가입                </a></small></p>
